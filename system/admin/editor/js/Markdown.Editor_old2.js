 ...
 * - Proper toolbar integration with Font Awesome icons
 * 
 * Key fixes made:
...
(function () {
    ...
    function UIManager(postfix, panels, undoManager, previewManager, commandManager, helpOptions, getString) {
        ...
        function makeSpritedButtonRow() {
            ...
            //makeSpacer(1);
            buttons.rtl = makeButton("wmd-rtl-button", getString("rtl"), "fa fa-align-right", bindCommand("doRTL"));
            buttons.ltr = makeButton("wmd-ltr-button", getString("ltr"), "fa fa-align-left", bindCommand("doLTR"));
