...
<div class="post entry full">
    ...
    <div class="featured-image">
        <?php echo generate_video_player($p->video, '100%', '100%', 'style="position:absolute;" class="embed-responsive-item"'); ?>
    </div>
    <?php endif; ?>
    ...
    <div class="entry-meta-bottom">
        ...
        <div class="author-meta">
            <img width="72" height="72" class="avatar avatar-72 photo" src="<?php echo $author->avatar;?>" alt="<?php echo $author->name;?>">                    
