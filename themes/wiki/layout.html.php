...
<head>
    ...
    <link rel="stylesheet" href="<?php echo site_url() ?>system/resources/css/fonts-arabic.css">
    ...
    <link rel="stylesheet" href="<?php echo theme_path();?>css/wiki.css" type="text/css" media="all">
...
<?php
    ...
    if (is_index()) {
        if (isset($is_front) && config('static.frontpage') === 'true') {
                $wikiClass = 'no-sidebar single';
        } else {
            if (config('teaser.type') === 'full') {
                $wikiClass = 'has-sidebar blog-layout-one-column-grid';
            } else {
                $wikiClass = 'has-sidebar blog-layout-two-column-grid';
            }
        }
    } elseif (isset($is_page) || isset($is_subpage)) {
        $wikiClass = 'no-sidebar single';
    } else {
        $wikiClass = 'has-sidebar single';
    }

?>
<body class="centered-theme-layout <?php echo $wikiClass;?> hfeed">
...
<svg width="0" height="0" style="display: none;">
    ...
    <div id="page" class="site">
        ...
        <div id="content" class="site-content">
            ...
            <section id="secondary" class="sidebar widget-area" role="complementary">
                ...
                <?php // Wiki sidebar: search + table of contents ?>
                <div id="wiki-search" class="widget tzwb-search">
                    <h3 class="widget-title"><?php echo i18n("Search");?></h3>
                    <div class="tzwb-content tzwb-clearfix">
                        <form role="search" method="get" id="searchform" action="<?php echo site_url()?>">
                            <input type="text" value="" name="s" id="s" placeholder="<?php echo i18n('Search');?>" />
                        </form>
                    </div>
                </div>

                <div id="wiki-toc" class="widget tzwb-toc">
                    <h3 class="widget-title"><?php echo i18n("Contents");?> <button id="wiki-toc-toggle" class="wiki-toggle" aria-expanded="true" aria-controls="wiki-toc-content">▾</button></h3>
                    <div id="wiki-toc-content" class="tzwb-content tzwb-clearfix"></div>
                </div>

                <div id="wiki-tags" class="widget widget_tag_cloud">
        ...
        <div class="footer-wrap">
            ...
            <div id="footer-line" class="site-info">
                ...
                <div class="credit-link">
                    <?php echo copyright();?> <span style="float:right;">Design: Occasio (adapted)</span>
                </div>
            </div>
            </footer><!-- #colophon -->
        </div>
    ...
    <script type="text/javascript" src="<?php echo theme_path();?>js/wiki.js" id="wiki-js"></script>
